...
public class CSVStream {
    ...
    protected CSVStream(Stream<Record> stream, List<ValidationError> validationErrors, String delimiter) {
        this.stream = stream;
        this.ps = System.out;
    ...
    public static CSVStream toCSVStream(Reader reader, CSVFormat csvFormat) throws IOException {
        ...
        return new CSVStream(recordStream.map(Record::new), Collections.synchronizedList(new ArrayList<>()), csvFormat.getDelimiterString());
    }
    ...
    public CSVStream copy() {
        ...
        return new CSVStream(newStream, validationErrors, delimiter);
    }
    ...
    public CSVStream deepCopy() {
        List<Record> recordsList = stream.toList();
        this.stream = recordsList.stream();
        return new CSVStream(recordsList.stream().map(Record::copy), validationErrors, delimiter);
    }
    ...
    public CSVStream peek(Consumer<Record> consumer) {
        return new CSVStream(stream.peek(consumer), validationErrors, delimiter);
    }
    ...
    public CSVStream validate(String column, Predicate<String> validator, String errorMessage) {
        ...
        return new CSVStream(validatedStream, validationErrors, delimiter);
    }
    ...
    public CSVStream rename(String columnBefore, String columnAfter) {
        ...
        return new CSVStream(tmp, validationErrors, delimiter);
    }
    ...
    public CSVStream printAsTable() {
        ...
        return new CSVStream(list.stream(), validationErrors, delimiter);
    }
    ...
    public CSVStream join(CSVStream other, String keyColumnCSVA, String keyColumnCSVB) {
        ...
        return new CSVStream(resultStream, validationErrors, delimiter);
    }
    ...
    public CSVStream consumeAndContinue() {
        ...
        return new CSVStream(tmp.stream(), validationErrors, delimiter);
    }
